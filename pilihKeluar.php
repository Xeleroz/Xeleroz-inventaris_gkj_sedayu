...
<head>
    ...
    <title>Kelola Barang Rusak</title>
...
if (isset($_GET["ubah"])) {
    ...
    if (isset($_GET['status'])) {
        ...
        echo '<h4 class="card-title">Pilih barang yang rusak</h4>';
    }
}
?>
          </div>
    ...
    <tr>
        ...
        <td>
            <a href="kelolaOut.php?id_barang=<?php echo $result['id_barang']; ?>" type="button" class="btn icon btn-primary"><i class="bi bi-check2-circle"></i> Pilih</i></a>
        </td>
    </tr>
    <?php
        }
