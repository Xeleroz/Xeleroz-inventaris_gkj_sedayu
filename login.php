        ...
        <div class="auth-box" style="display: flex; width: 100%; max-width: 1100px; margin: 0 auto;">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <p class="auth-subtitle mb-1" style="font-size: 1.2em; text-align: center;">Inventaris Gereja </p>
                    <p class="auth-subtitle mb-3" style="font-size: 1.2em; text-align: center;">GKJ Sedayu</p>
                    <?php if($err){ ?>
